...
= 1.18.19 =
* Change how subscription status is determined

= 1.18.18 =
* Fix for race condition w/ POST variables when publishing a new post

= 1.18.17 =
* Fixing bug with expiration calculation
...
= 1.18.10 =
* Better validationg of usernames when updating them :)
